        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap justify-center gap-6 md:gap-8">
            <div className="w-full max-w-md px-4 mb-6 md:mb-8">
              <div>
                <h3 className="text-base md:text-lg font-semibold mb-4 text-center">Get in Touch</h3>
                <p className="mb-6 text-xs md:text-sm text-center">
            ...
            <div className="w-full max-w-md px-4 mb-6 md:mb-8">
              <div>
                <h3 className="text-base md:text-lg font-semibold mb-4 text-center">Fill Up The Form</h3>
                <p className="mb-6 text-xs md:text-sm text-center">Your email address will not be published. Required fields are marked *</p>
