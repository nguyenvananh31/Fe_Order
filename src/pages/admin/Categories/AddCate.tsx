...
import { Breadcrumb, Button, Form, Image, Input, Upload } from 'antd';
import useAddCate from './utils/add-categories.hooks';
const { TextArea } = Input;


export default function ListCategories() {
    const { ...hooks } = useAddCate();
        ...
        <div className="">
            <Breadcrumb
                ...
                items={[
                    ...
                    {
                        title: <h1 className="font-bold">Thêm danh mục</h1>,
                    },
                ]}
            />
